		...
		<section className="about">
			<div className="container">
				...
				<div className="about__content">
					<p>My name is <strong>Hatam</strong>! I’ve been doing over 4 years experience in Front-end Development and over 6 years in Web development in General. During all this time I managed to work in several web studios and freelance, gained a lot of experience, the last place I worked as a web studio "Lained" in the position of "Head of front-end development department".</p>
					
					<h4><span role="img" aria-label="">💪</span> My Skills:</h4>
					<ul>
					...
					<p>My principle <strong>“Quality is always comes first”</strong>.</p>

					<h4><span role="img" aria-label="">🎯</span> My goal</h4>
					<p>Become a professional front-end developer <span role="img" aria-label="">😎</span></p>
				</div>
			</div>
		</section>
	)
