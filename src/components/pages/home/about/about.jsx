			...
			<div className="container">
				...
				<div className="about__content">
					<p>
						...
						with commercial projects and more than 6 years in web development in general. During all this time I managed
						to work in several web studios and freelance platforms, got a big experience in a team, extensive experience
					...
					<ul>
						...
						<li>
							Development on React.js (Hooks, Context, Redux, Formik, Transition Group, scrollmonitor). CSS, SASS,
							inline styles.
						</li>
						<li>
